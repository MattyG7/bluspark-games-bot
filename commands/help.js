...
module.exports.run = async (bot, message, args) => {
  ...
  .addField("Actions", "`poke, punch, kill, greet, slap, lick, pinch, pat, hug, kiss, snog, bite, eat, stickouttongue, sad, cry, laugh, congrats, scare, dance, brushhair, excited, thinking`")
  .addField("Emotions & Solo Actions", "`sad, cry, laugh, dance, brushhair, excited, thinking`")
  //.addField("Actions", "`insult, mad, endlessgift, themepark, stop, run`")
  //.addField("Emotions", "`cute, bored, happy, cheer, mad, blush, themepark, dizzy`")
