...
module.exports.run = async (bot, message, args) => {
  ...
  .addField("Actions", "`poke, punch, kill, greet, slap, lick, pinch, pat, hug, kiss, snog, bite, eat, stickouttongue, happy, sad, cry, laugh, cheer, congrats, scare, dance, brushhair, excited, thinking, cute, bored, insult`")
  .addField("Emotions & Solo Actions", "`happy, sad, cry, laugh, cheer, dance, brushhair, excited, thinking, cute, bored, insult`")
  //.addField("Actions", "`mad, endlessgift, themepark, stop, run`")
  //.addField("Emotions", "`mad, blush, themepark, dizzy`")
